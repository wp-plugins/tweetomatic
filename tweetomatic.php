...
define('TWEETOMATIC_VERSION', 'basic_0.05');
...
function tweetomatic ( $atts, $content = null ) {
	...
	if($tweetomatic_config['show_powered_by'] == "false")
		...
		$final = $html . "	<div style='display: block !important; font-size: 12px;'>Powered by <a target='_blank' href='http://tweetomatic.co.uk/'>Tweetomatic</a></div>\n</div>\n\n";
